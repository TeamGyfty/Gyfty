            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info="A unique handle for your profile URL. Your full name, nickname or whatever you like!"
                />
                <SelectListGroup
                  placeholder="Status"
                  name="status"
                  ...
                  options={options}
                  error={errors.status}
                  info="Give us an idea of your status"
                />
                ...
                <TextFieldGroup
                  ...
                  info="You can add your website url if you like!"
                />
                <TextFieldGroup
